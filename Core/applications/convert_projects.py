...
from typing import Any, Dict  # Add this import
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert project YAML files to normalized schema"
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    if success:
        ...
        logger.info(
            "📝 Review the converted files, then manually replace originals if needed."
        )
    else:
